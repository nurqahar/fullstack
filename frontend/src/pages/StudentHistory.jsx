  ...
  return (
    <Container className="mt-5" data-bs-theme="dark">
      <Form>
        ...
        <p>Manage student class enrollment and status</p>
        <p className="text-warning">
          Note: A student can only be active in one class at a time
        </p>
        <Row>
        ...
        <Table stripped="true" bordered hover className="text-center">
          ...
          <tbody>
            <tr>
              ...
              <td className="align-middle">X TOI 1</td>
              <td className="align-middle">1</td>
              <td className="align-middle">2025/2026</td>
